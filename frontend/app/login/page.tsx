    ...
    <div className="min-h-screen mesh-bg flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              <div className="flex justify-between mb-1.5">
                ...
                <span className="text-xs text-brand-400 cursor-pointer hover:text-brand-300">Forgot?</span>
              </div>
              <div className="relative">
                <input {...register("password")} type={show?"text":"password"} placeholder="••••••••" className="input-field pr-11" />
        ...
        <p className="text-center text-sm text-slate-500 mt-5">
          No account? <Link href="/register" className="text-brand-400 hover:text-brand-300">Create one free</Link>
        </p>
      </div>
    </div>
  );
